        ...
        <footer>
            <div className="social">
                ...
                <div className="social-body">
                    <a className="github-box" href="https://github.com/sayanbiswas2468" target="_blank">
                        <p>Github</p>
                    ...
                    <a className="linkedin-box" href="https://www.linkedin.com/in/sayanbiswas2468/" target="_blank">
                        <p>LinkedIn</p>
                        <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="twitter-box" href="https://codolio.com/profile/OdQyCHDQ" target="_blank">
                        <p>Leetcode</p>
                        <SiLeetcode />
                    </a>
                    <a className="schedule-box" href="https://www.instagram.com/imsay0n/" target="_blank">
                        <p>Instagram</p>
                        <FaInstagram />
                    </a>
                </div>
                <a className="social-mail" href="mailto:sayanbiswas2468@gmail.com" target="_blank">
                    <div className="box">
                        <p>Shoot Me A Mail</p>
